...
const reasons = [
  ...
  {
    title: "Full Lifestyle Services",
    description: "Hair dressing, massage, pedicure and manicure — all under one roof.",
  ...
  },
  {
    ...
    description: "Located at Melrose Crossing, Birnam — easy to find, easy to reach.",
...
export function WhyChooseUs() {
  return (
    <section className="py-24">
      <Container>
        <SectionHeading
          title="Why Choose Noel's Barbershop"
